function switchingcurve_Nfinite_mfeq
...
%    optimum. In the folder data, there are stored the matrices obtained in 
%    SIR-MFG-vs-Nplayergame.ipynb
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

addpath('ternaryplotfiles')
mat=dlmread('data/eqpol_t0_n5.txt')
ind=1;
N=5;
for j=1:N+1
  for i=2:N-j+2
...
mat=dlmread('data/eqpol_t0_n10.txt')
ind=1;
N=10;
for j=1:N+1
  for i=2:N-j+2
...
ternplot(x,y)
mat=dlmread('data/eqpol_t0_n20.txt')
ind=1;
N=20;
for j=1:N+1
  for i=2:N-j+2
...
mat=dlmread('data/eqpol_t0_n30.txt')
ind=1;
N=30;
for j=1:N+1
  for i=2:N-j+2
...
mat=dlmread('data/eqpol_t0_n40.txt')
ind=1;
N=40;
for j=1:N+1
  for i=2:N-j+2
...
mat=dlmread('data/eqpol_t0_n50.txt')
ind=1;
N=50;
for j=1:N+1
  for i=2:N-j+2
...
mat=dlmread('data/eqpol_t0_mf.txt')
ind=1;
N=size(mat,1);
for j=1:N+1
  for i=2:N-j+2
